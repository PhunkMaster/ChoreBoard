"""
DEBUG SCRIPT: Manual Phase 5 Feature Verification

Purpose: Manually tests and verifies Phase 5 features work correctly in production.

Usage: python debug/manual_phase5_verification.py

This script tests:
1. All 5 schedule types (Daily, Weekly, Every N Days, Cron, RRULE)
2. Parent-child chore dependency creation
3. Child chore auto-assignment to parent completer (pool and assigned scenarios)
4. Multiple child chores spawning from one parent
5. Offset hours in due time calculations

Useful for: Verifying Phase 5 features after deployment or database migrations
"""
import os
import sys
import django
