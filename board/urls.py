...
urlpatterns = [
    ...
    path('admin-panel/midnight-evaluation/', views_admin.admin_midnight_evaluation, name='admin_midnight_evaluation'),
    path('admin-panel/midnight-evaluation/run/', views_admin.admin_midnight_evaluation_run, name='admin_midnight_evaluation_run'),
    path('admin-panel/midnight-evaluation/check/', views_admin.admin_midnight_evaluation_check, name='admin_midnight_evaluation_check'),
    ...
    path('admin-panel/backup/delete/<int:backup_id>/', views_admin.admin_backup_delete, name='admin_backup_delete'),
    ...
    path('admin-panel/chore/create-instance/<int:chore_id>/', views_admin.admin_chore_create_instance, name='admin_chore_create_instance'),
    # Skip/Unskip Chore
